...
export default class VolunteerUpcoming extends Component {
  ...
  getRequest = () => {
    ...
    axios
      .get(`http://localhost:2000/volunteer-get-my-upcoming-request${data}`, {
        headers: {
  ...
  removeRequest = (id) => {
    axios
      .post(
        "http://localhost:2000/remove-volunteer-from-request",
        {
          id: id,
        },
        {
  ...
  completeRequest = (id) => {
    axios
      .post(
        "http://localhost:2000/complete-request",
        {
          id: id,
        },
        {
