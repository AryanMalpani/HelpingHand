...
export default class SeekerAccepted extends Component {
    constructor() {
        super();
        this.state = {
            token: '',
    ...
    getRequest = () => {
        ...
        axios.get(`http://localhost:2000/seeker-get-accepted-request${data}`, {
        headers: {
...
render() {
    return (<>
        ...
        <h2 style={{marginBottom:'1rem'}}>Accepted Requests</h2>
        ...
        {this.state.requests.map((row) => (
            ...
            <TableCell align="center">{row.volunteer_id.fname +" "+ row.volunteer_id.lname}</TableCell>
